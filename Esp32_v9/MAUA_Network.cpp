...
#include "MAUA_Network.h"
#include "MAUA_Sensors.h"
#include "MAUA_Storage.h"
#include "MAUA_Interface.h"
...
String baseName = "MAUA Satélite ";       // WiFi Base SSID to have the id string added
const char* password = "meusatmaua";      // Default WiFi Password
...
__attribute__((weak)) void networkConnect(){
  ...
  // Cria uma nova String com o nome MAUA Satélite + o serial
  ...
  WiFi.setHostname("MAUA Satelite");
}

__attribute__((weak)) void serverResponse(){
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    // Send File
    // To use webpage.h uncomment lines below 
